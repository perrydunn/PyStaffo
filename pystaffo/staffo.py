...
class StaffoAccount:
    def __init__(self, subdomain, user, password):
        ...
        self.timezone = cached.get_timezone(self.auth, self.base_url)
        self.locations = cached.get_locations(self.auth, self.base_url)
        self.departments = cached.get_departments(self.auth, self.base_url)
    ...
    def get_location(self, loc_name):
        ...
        specific = requestors.get(auth=self.auth, url=self.base_url + 'locations/{id}.json'.format(id=location_id))
        return specific
    ...
    def get_department(self, loc_name, dep_name):
        ...
        specific = requestors.get(auth=self.auth, url=self.base_url + 'locations/{loc_id}/departments/{dep_id}.json'.
    ...
    def get_all_users(self, state=None):
        ...
        if not state:
            return requestors.get(auth=self.auth, url=self.base_url + extension)
        else:
            return requestors.get(auth=self.auth, url=self.base_url + extension, extras={'state': state})
    ...
    def get_loc_schedules(self, loc_name, schedule_id=None, start_date=None, end_date=None):
        ...
        if schedule_id:
            ...
            return requestors.get(auth=self.auth, url=self.base_url + extension, extras=params)
    ...
    def add_users(self, loc_name=None, dep_name=None, users=[], remove=False):
        ...
        return requestors.put(auth=self.auth, url=self.base_url + extension, data=params)
    ...
    def create_location(self, loc_name=None, allow_self_assign=True, applications_visible=False,
        ...
        return requestors.post(auth=self.auth, url=self.base_url + 'locations.json', data=params)
    ...
    def create_department(self, loc_name=None, dep_name=None, visibility='staff', color='4286f4', user_selectable=True,
        ...
        return requestors.post(auth=self.auth, url=self.base_url + extension, data=params)
